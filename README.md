...
> **Storage is optional**: This config works immediately for LLM and MCP features. Storage features activate automatically when MinIO is running. For storage/context features, see [Storage Configuration Options](#storage-configuration-options) below.
